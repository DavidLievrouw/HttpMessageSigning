        ...
        public IHashAlgorithm Create(HashAlgorithm hashAlgorithm) {
            switch (hashAlgorithm) {
                ...
                case HashAlgorithm.SHA1:
                    return new RealHashAlgorithm(hashAlgorithm, "SHA-1", SHA1.Create());
                case HashAlgorithm.SHA256:
                    return new RealHashAlgorithm(hashAlgorithm, "SHA-256", SHA256.Create());
                case HashAlgorithm.SHA384:
                    return new RealHashAlgorithm(hashAlgorithm, "SHA-384", SHA384.Create());
                case HashAlgorithm.SHA512:
                    return new RealHashAlgorithm(hashAlgorithm, "SHA-512", SHA512.Create());
                default:
