...
namespace Dalion.HttpMessageSigning.SigningString.RequestTarget {
    public class RFC2396RequestTargetEscaperTests {
        private readonly RFC2396RequestTargetEscaper _sut;

        public RFC2396RequestTargetEscaperTests() {
            _sut = new RFC2396RequestTargetEscaper();
        }

        public class Escape : RFC2396RequestTargetEscaperTests {
            ...
            [Fact]
            public void GivenAbsoluteUri_EscapesRFC3986EscapedUri() {
                var requestTarget = new Uri(
            ...
            [Fact]
            public void GivenRelativeUri_EscapesRFC3986EscapedUri() {
                var requestTarget = new Uri(
