...
namespace Dalion.HttpMessageSigning.BasicECDsa {
    public class BasicECDsaSystemTests : IDisposable {
        ...
        public BasicECDsaSystemTests(ITestOutputHelper output) {
            _output = output;
        ...
        private static void ConfigureServices(IServiceCollection services) {
            ...
            var privateKey = ecdsa.ExportParameters(includePrivateParameters: true);
